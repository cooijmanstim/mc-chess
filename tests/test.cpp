...
BOOST_AUTO_TEST_CASE(regression1) {
  std::vector<Move> trail = {
    41872, 21600, 44848, 24624, 53168, 25745, 49120, 30945, 43808, 9248, 34577,
    39392, 38640, 3136, 61232, 10288, 53184, 19616, 47968, 10624, 62256, 28976,
    53168, 20672, 51840, 3232, 56272, 16400, 46928, 19632, 48720, 31985, 55232,
    6256, 45872, 30144, 63312, 23632, 36544, 2096, 38608, 15696, 64048, 34052,
    9188, 7264, 17536, 5488, 36112, 40960, 35376, 144, 37728, 21968, 64496,
    48740, 36640, 44564, 56288, 3104, 39648, 27312, 26164, 12336, 31328, 30964,
    10640, 14672, 36384, 23776, 33328, 40432, 44608, 49796, 55248, 14416, 35488,
    15472, 53152, 56052, 25392, 48608, 56148, 28992, 51712, 27952, 20640, 16800,
    37552, 21728, 30272, 14576, 63328, 9408, 50052, 42128, 37664, 46736, 46916,
    15584, 56064, 26912, 52064, 7504, 14656, 55024, 20704, 37716, 61824, 18432,
    56272, 31296, 22992, 25888, 43968, 18832, 31044, 21712, 53024, 12528, 4448,
    14528, 29348, 22752, 54064, 10496, 63328, 16544, 62416, 11552, 50624, 35252,
    13792, 32112, 23760, 34048, 11332, 55648, 53056, 24052, 29872, 28176, 55088,
    38324, 37328, 30032, 61376, 48720, 15120, 14708, 28224, 21728, 18864, 29008,
    53072, 53092, 62384, 38336, 11552, 64240, 63424, 12084, 56272, 13488, 63328,
    14544, 62416, 39136, 39636, 57456, 61376, 15232, 60336, 36064, 30308, 54240,
    59296, 50736, 21968, 36624, 13648, 22064, 5335, 30288, 21588, 37328, 52112,
    45632, 13648, 48752, 29904, 64320, 38352, 47072, 5712, 36544, 6224, 29392,
    3168, 45616, 50976, 39360, 7216, 53952, 40048, 46912, 24176, 56932, 48500,
  };

  // this move was not considered to leave the king in check because
  // of a bug in State::leaves_king_in_check.  it moves the king from
  // an attacked square to another square that is also attacked, but
  // the attack was considered blocked by the same king on the old square.
