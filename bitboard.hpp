...
namespace squares {
  auto partition = [](){
    ...
    return TrivialBoardPartition(names,
                                 [](size_t index) {
...
namespace files {
  auto partition = [](){
    std::initializer_list<std::string> names = {"a", "b", "c", "d", "e", "f", "g", "h"};
    return BoardPartition(names,
                          [](size_t index) {
...
namespace ranks {
  auto partition = [](){
    std::initializer_list<std::string> names = {"1", "2", "3", "4", "5", "6", "7", "8"};
    return BoardPartition(names,
                          [](size_t index) {
...
namespace diagonals {
  auto partition = [](){
    std::initializer_list<std::string> names = { "h8h8", "g8h7", "f8h6", "e8h5", "d8h4", "c8h3", "b8h2", "a8h1", "a7g1", "a6f1", "a5e1", "a4d1", "a3c1", "a2b1", "a1a1" };
    return BoardPartition(names,
                          [](size_t index) {
...
namespace antidiagonals {
  auto partition = [](){
    std::initializer_list<std::string> names = { "a8a8", "a7b8", "a6c8", "a5d8", "a4e8", "a3f8", "a2g8", "a1h8", "b1h7", "c1h6", "d1h5", "e1h4", "f1h3", "g1h2", "h1h1" };
    return BoardPartition(names,
                          [](size_t index) {
